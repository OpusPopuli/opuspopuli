...
<html>
  ...
  <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #222222;">
    <div style="text-align: center; margin-bottom: 32px;">
      <h1 style="color: #222222; font-size: 24px; margin: 0;">${data.platformName}</h1>
    </div>

    <h2 style="color: #222222; font-size: 20px;">${greeting}!</h2>
    ...
    <div style="text-align: center; margin: 32px 0;">
      <a href="${data.loginUrl}"
         style="background-color: #222222; color: white; padding: 14px 28px;
