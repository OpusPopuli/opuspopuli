      ...
      {rep.bio && (
        <div className="bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.06)] p-8 mb-6">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-xs font-bold uppercase tracking-[1.5px] text-[#595959]">
              Biography
            </h2>
          ...
          {rep.bioSource === "ai-generated" && (
            <p className="mt-3 text-[11px] text-[#94a3b8] italic">
              Generated from public record data. May contain inaccuracies —
              verify against official sources before citing.
            </p>
          )}
        </div>
      )}
