        ...
        <>
          ...
          <div>
            ...
            <input
              ...
              required
              maxLength={200}
              className="w-full px-4 py-2 border border-line rounded-lg focus:border-content focus:ring-1 focus:ring-content outline-none"
          ...
          {sendMethod === "platform" && (
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="rounded text-content"
              />
