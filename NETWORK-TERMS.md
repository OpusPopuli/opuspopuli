...
Subdomains may not be used for:
- Commercial purposes or for-profit activities
- Political campaign activities or partisan advocacy
...
Members must:
- Maintain a functioning deployment of the Platform
- Keep the Platform reasonably updated with security patches
- Ensure the deployment is accessible and functional
- Implement appropriate security measures

### 3.4 Content Responsibility

Members are solely responsible for:
- All content published under their Subdomain
...
- Support the civic mission of the Network

### 4.2 Open Source Compliance

Members must:
- Maintain AGPL-3.0 licensing for Platform modifications
- Make source code available as required by AGPL-3.0
- Properly attribute upstream contributions
...
This data is used solely for Network administration.
...
Continued Network participation after the notice period constitutes acceptance of modified Terms.
...
Any legal proceedings shall be conducted in the state or federal courts located in Delaware.
